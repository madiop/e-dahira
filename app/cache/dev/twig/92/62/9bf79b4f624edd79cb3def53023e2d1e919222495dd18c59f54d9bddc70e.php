...
/* EdahiraDahiraBundle:Typeevenement:supprimer.html.twig */
class __TwigTemplate_92629bf79b4f624edd79cb3def53023e2d1e919222495dd18c59f54d9bddc70e extends Twig_Template
{
    ...
    public function block_body_header($context, array $blocks = array())
    {
        // line 8
        echo "\t<h1>";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("text.suppression", array("%objet%" => ("type d'évènement: " . $this->getAttribute((isset($context["type"]) ? $context["type"] : $this->getContext($context, "type")), "nom"))), "EdahiraDahiraBundle"), "html", null, true);
        echo "</h1>
";
    }
...
";
    ...
    {
        return "EdahiraDahiraBundle:Typeevenement:supprimer.html.twig";
    }
